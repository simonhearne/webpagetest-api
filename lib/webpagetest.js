...
var paths = {
  ...
  filmstrip: 'video/downloadFrames.php',
...
function getFilmstrip(id, options, callback) {
  var query,
      pathname = paths.filmstrip;
  ...
  helper.setQuery(mapping.commands.filmstrip, options, query);
